...
<div class="max-w-6xl mx-auto px-4 pt-6 pb-12">
    <div class="flex flex-col md:flex-row gap-6">
        <div class="hidden md:block md:w-1/4 md:sticky md:top-20 self-start">
                ...
                <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="bg-white rounded-2xl p-5 shadow-soft hover-lift border border-gray-100">
                        <div class="flex items-center space-x-4 flex-wrap">
                            ...
                            <input type="text" name="content" placeholder="What's on your mind?" class="flex-grow bg-gray-50 rounded-full px-5 py-3 focus:outline-none focus:ring-2 focus:ring-brand-300 transition text-gray-700 mt-3 sm:mt-0" required>
                            <button type="submit" class="bg-brand-500 text-white rounded-full px-6 py-3 hover:bg-brand-600 transition font-medium shadow-sm mt-3 sm:mt-0 sm:ml-3 w-full sm:w-auto">
                                Post
                            </button>
                        </div>
                        ...
                        <div class="flex mt-4 pt-3 border-t border-gray-100 space-x-4 flex-wrap">
