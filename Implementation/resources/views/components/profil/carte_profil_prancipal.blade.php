    ...
    <div class="relative px-6 py-6">
        <div class="absolute -top-16 left-6">
            <div class="w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-md bg-white">
                <img
                    src="{{ asset('storage/' . $user->profile_image ?? 'default-avatar.png') }}"
                    alt="Profile Image"
            ...
            <div>
                ...
                <div class="flex items-center space-x-3">
                    <div class="w-12 h-12 rounded-full overflow-hidden bg-gray-100">
                        <img src="{{ asset('storage/' . $user->profile_image ?? 'default-avatar.png') }}" alt="Current profile" class="w-full h-full object-cover">
                    </div>
