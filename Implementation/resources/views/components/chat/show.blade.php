...
<body class="bg-instagram-white font-sans text-instagram-extraDarkGray">
    ...
    <div class="max-w-3xl mx-auto px-4 py-4">
        ...
        <div class="bg-white rounded-lg overflow-hidden">
            ...
            <!-- Message input area - Instagram style -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Set up Echo to listen for events on a private channel
            ...
            channel.bind('App\\Events\\NewMessage', function(data) {
                if (data.message.sender_id == {{ $otherUser->id }}) {
                    ...
                    // Mark message as read by sending a request to the server
            ...
            chatForm.addEventListener('submit', function(e) {
                ...
                .then(data => {
                    // Add the message to the chat (for the sender)
                    const messageDiv = document.createElement('div');
            ...
            // Instagram-style disable/enable send button based on input
