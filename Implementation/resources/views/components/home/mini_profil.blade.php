    ...
    <div class="w-70 bg-white rounded-3xl border border-blue-400 shadow-md p-6">
        ...
        <div class="pt-16 pb-6 px-4 text-center">
            ...
            <div class="flex justify-center items-center mt-6 space-x-2">
                <span class="text-black font-bold text-2xl">10K</span>
                <span class="text-gray-400">follow</span>
            </div>
    
            <button class="mt-6 border border-blue-400 text-blue-500 rounded-full px-6 py-2 text-sm uppercase hover:bg-blue-50 transition">
                VOIR LE PROFIL
            </button>
        </div>
    </div>
